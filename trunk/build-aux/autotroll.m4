...
dnl Memo: AC_ARG_WITH(package, help-string, [if-given], [if-not-given])
  ...
  AC_CHECK_TOOLS([QMAKE], [qmake qmake-qt4 qmake-qt3], [missing],
  ...
  AC_CHECK_TOOLS([MOC], [moc moc-qt4 moc-qt3], [missing],
  ...
  AC_CHECK_TOOLS([UIC], [uic uic-qt4 uic-qt3 uic3], [missing],
                [$QT_PATH:$PATH:$tmp_qt_paths])
...
[Cannot find uic (User Interface Compiler). Try --with-qt=PATH.])
  ...
  AC_CHECK_TOOLS([RCC], [rcc], [false], [$QT_PATH:$PATH:$tmp_qt_paths])
